...
/**
 * Fluent assertions for AWS::Lambda::EventInvokeConfig. This should be used if the resource map is extracted from
 * the AWS template. Otherwise, start with {@link CDKStackAssert#containsLambdaEventInvokeConfig(String)} or {@link CDKStackAssert#containsLambdaEventInvokeConfig(String, String, String)} .
 * <p>
 * Examples:
 * <br/>
 * When there is no success and failure destinations configured:
 * </p>
 * <pre>
 *     {@code
 ...
 *             </pre>
 *
 * <p>When there are success and failure destinations configured:</p>
 * <pre>
 *     {@code
 *     LambdaEventInvokeConfigAssert.assertThat(map)
